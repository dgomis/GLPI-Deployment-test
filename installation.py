...
print("*** Attribution des droits sur le rep /tmp/Downloads ***")
try:
	os.system('chmod -R 777 /tmp/Downloads')
except Exception as g:
	print("*** Erreur d'attribution des droitssur tmp : {g} ***")
	sys.exit(3)
else:
	print("*** Droits accordés sur /tmp/Downloads ***")
...
# On installe la base de données GLPI en mode CLI
print("*** Début de création de la base de donnée GLPI en mode cli ***")
try:
