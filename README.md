...
3. APPORTER DES MODIFICATIONS (commit)
...
4. OUVRIR UN PULL REQUEST (extractions)
...
5. DANS CETTE DERNIÈRE ÉTAPE, il est temps d'apporter vos modifications en les fusionnant à partir de vos 
